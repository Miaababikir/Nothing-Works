<nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-1/2 pl-2 md:pl-0 flex items-center">
            <img class="h-12 inline-block" src="{{ asset('images/logo.png') }}" alt="logo">
            <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline" href="#">
                Nothing Works
            </a>
        </div>
            ...
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="/dashboard/tags"
                       class="block py-1 md:py-3 pl-1 align-middle no-underline hover:text-gray-900 border-b-2 border-white hover:border-teal-400 {{ (request()->is('dashboard/tags*')) ? 'nav-active' : 'text-gray-500' }}">
                        <i class="fa fa-tag fa-fw mr-3 {{ (request()->is('dashboard/tags*')) ? 'text-teal-400' : '' }}"></i><span class="pb-1 md:pb-0 text-sm">Tags</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="#"
